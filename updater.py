...
def run_process():
    print(f"Gerçek Veri Çekiliyor... Tarih: {target_date.strftime('%Y-%m-%d')}")
    
    try:
        # BETA SİSTEMİNDEN NETCDF VERİSİ ÇEKME
        c.retrieve(
        ...
        for il, (lat, lon) in iller_koordinat.items():
            ...
            # GitHub'ın değişikliği algılaması için mikro-fark
